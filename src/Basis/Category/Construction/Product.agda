...
(𝒳 ⊗ 𝒴) .idn₁ = idn₁ 𝒳 , idn₁ 𝒴
(𝒳 ⊗ 𝒴) .cmp₁ (α₁ , β₁) (α₀ , β₀) = cmp₁ 𝒳 α₁ α₀ , cmp₁ 𝒴 β₁ β₀
(𝒳 ⊗ 𝒴) .inv₁ (α , β) = inv₁ 𝒳 α , inv₁ 𝒴 β
(𝒳 ⊗ 𝒴) .coh-λ = coh-λ 𝒳 , coh-λ 𝒴
(𝒳 ⊗ 𝒴) .coh-ρ = coh-ρ 𝒳 , coh-ρ 𝒴
(𝒳 ⊗ 𝒴) .coh-α = coh-α 𝒳 , coh-α 𝒴
(𝒳 ⊗ 𝒴) .coh-ω (α₁ , β₁) (α₀ , β₀) = coh-ω 𝒳 α₁ α₀ , coh-ω 𝒴 β₁ β₀
...
⟨_,_⟩ : ∀ {𝒳 𝒴 𝒵} → Functor 𝒳 𝒴 → Functor 𝒳 𝒵 → Functor 𝒳 (𝒴 ⊗ 𝒵)
⟨ F , G ⟩ .ap₀ = T.⟨ ap₀ F , ap₀ G ⟩
⟨ F , G ⟩ .ap₁ = T.⟨ ap₁ F , ap₁ G ⟩
⟨ F , G ⟩ .ap₂ = T.⟨ ap₂ F , ap₂ G ⟩
...
⟨_⊗_⟩ : ∀ {𝒳 𝒴 𝒞 𝒟} → Functor 𝒳 𝒞 → Functor 𝒴 𝒟 → Functor (𝒳 ⊗ 𝒴) (𝒞 ⊗ 𝒟)
